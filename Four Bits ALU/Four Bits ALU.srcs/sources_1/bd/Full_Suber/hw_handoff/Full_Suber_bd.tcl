...
################################################################
# This is a generated script based on design: Full_Suber
#
...
proc create_root_design { parentCell } {
  ...
  set Borrow [ create_bd_port -dir O Borrow ]
  set C [ create_bd_port -dir I C ]
  set Diff [ create_bd_port -dir O Diff ]
  ...
  connect_bd_net -net A0_0_1 [get_bd_ports B] [get_bd_pins decode138_0/A0]
  connect_bd_net -net A1_0_1 [get_bd_ports A] [get_bd_pins decode138_0/A1]
  connect_bd_net -net A2_0_1 [get_bd_ports C] [get_bd_pins decode138_0/A2]
  connect_bd_net -net decode138_0_Y1_n [get_bd_pins decode138_0/Y1_n] [get_bd_pins xup_nand4_0/a] [get_bd_pins xup_nand4_1/a]
  connect_bd_net -net decode138_0_Y2_n [get_bd_pins decode138_0/Y2_n] [get_bd_pins xup_nand4_0/b]
  connect_bd_net -net decode138_0_Y4_n [get_bd_pins decode138_0/Y4_n] [get_bd_pins xup_nand4_0/c] [get_bd_pins xup_nand4_1/b]
  connect_bd_net -net decode138_0_Y5_n [get_bd_pins decode138_0/Y5_n] [get_bd_pins xup_nand4_1/c]
  ...
  connect_bd_net -net xup_nand4_0_y [get_bd_ports Diff] [get_bd_pins xup_nand4_0/y]
  connect_bd_net -net xup_nand4_1_y [get_bd_ports Borrow] [get_bd_pins xup_nand4_1/y]
